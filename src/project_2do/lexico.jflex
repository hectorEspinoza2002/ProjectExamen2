...
<YYINITIAL>{
    ...
    ":"     {   return symbol("DOS_PUNTO",Simbolo.DOS_PUNTO);                  }
    ...
    "<="     {   return symbol("MENOR_QUE",Simbolo.MENORIGUAL);             }

    ">="     {   return symbol("MAYOR_QUE",Simbolo.MAYORIGUAL);             }

    "!="     {   return symbol("DISTINTODE",Simbolo.DISTINTODE);             }
